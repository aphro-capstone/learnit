		...
		<div class="panel-content mt-4">
			<div class="row">
				...
				<div class="col-sm-12 col-md-4 col-lg-4">
					<div class="game-box videobox">
						<div class="img-container">
								<img class="full-width" src="<?php echo base_url();  ?>/assets/images/games/v2.png" alt="">
						</div>
						<div class="backtext">
							<i class="fa fa-play-circle">
								</i>
				...
				<div class="col-sm-12 col-md-4 col-lg-4">
					<div class="game-box videobox">
						<div class="img-container">
							<img class="full-width" src="<?php echo base_url();  ?>/assets/images/games/v3.png" alt="">
						</div>
						<div class="backtext">
							<i class="fa fa-play-circle">
								</i>
