...
class Teacher extends MY_Controller {
	...
	private function uploadlibraryfiles(){
	...
	private function removeFolderFile(){
	...
	private function fetchAssignees(){
	...
	public function getDownloadablefiles($ID){
	  ...
	  public function createzip(){
		...
		var_dump( fcpath );
		  // File path
		  $filepath1 = FCPATH.'/assets/css/project.css';
